                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;" align="left">
                                                            <div style="color: #686d6d; line-height: 210%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 210%;"><span style="font-size: 16px; line-height: 33.6px;">Hello {{$kaizenDetails['name']}},</span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 210%;">Well Done {{$kaizenDetails['name']}}! You are the winner of Kaizen competition. we are extremely grateful! </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
