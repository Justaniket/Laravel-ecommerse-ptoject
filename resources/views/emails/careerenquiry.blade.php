                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;" align="left">
                                                            <div style="color: #686d6d; line-height: 210%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 210%;"><span style="font-size: 16px; line-height: 33.6px;">Hello {{ $firstname }},</span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 210%;">We have recived your details successfully. Zillion team will review your details and get back to you. </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px 10px;font-family:'Montserrat',sans-serif; border-bottom: 1px dashed #aaa" align="left">
                                                            <div align="left">
                                                                <p style="font-size: 14px; line-height: 210%;"><span style="font-size: 16px; line-height: 33.6px;">Regards,<br> <b>Zillion Link Team</span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
