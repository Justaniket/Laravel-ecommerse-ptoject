                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;" align="left">
                                                            <div style="color: #686d6d; line-height: 210%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 210%;"><span style="font-size: 16px; line-height: 33.6px;">Hello {{$trainerDetails['name']}},</span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 210%;">Well Done {{$trainerDetails['user_name']}}! You successfully completed the training. we are extremely grateful! </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
