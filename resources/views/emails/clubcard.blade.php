        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;" align="left">
                                                            <div style="color: #34495e; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;"><strong><span style="line-height: 36.4px; font-size: 26px;">Zillion Link</span>
                                                                    </strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;" align="left">
                                                            <div style="color: #686d6d; line-height: 210%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 210%;"><span style="font-size: 16px; line-height: 33.6px;">Hello {{ $name }},</span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 210%;">Thank you {{ $name }} for your vote of confidence and welcome to the Zillion Link Clubcard Family. We are grateful and promise you a delightful service.</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                    ...
                    <table style="width: 100%;margin-left: 141px;">
                        <tr><td>&nbsp;</td></tr>
                        ...
                        <tr><td>Transaction ID: {{$razorpay_payment_id}}</td></tr>
                        <tr><td>
                            <table style="width: 50%;" cellpadding="5" cellspacing="5" bgcolor="#f7f4f4">
                                ...
                                <tr>
                                    <td>Zillion Club Card</td>
                                    <td>₹ 799</td>
                                </tr>
                                <tr>
                                    <td align="right">Grand Total</td><td>₹ 799</td>
                                </tr>
                            </table>
                        </td></tr>
                    </table>
                    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px 10px;font-family:'Montserrat',sans-serif; border-bottom: 1px dashed #aaa" align="left">
                                                            <div align="left">
                                                                <p style="font-size: 14px; line-height: 210%;"><span style="font-size: 16px; line-height: 33.6px;">Regards,<br> <b>Zillion Link Team</b></span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
