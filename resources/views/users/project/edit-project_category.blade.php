        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <!--     <a href="{{ url('/admin/view-product') }}"><button style="float: right; margin: 3px 3px;background:#2f2f86;" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View Section</button></a> -->
                 ...
                 <form method="POST" action="{{ url('users/edit-project_category/'.$project_category->id) }}" enctype="multipart/form-data" id="bannerForm" name="bannerForm">@csrf
                <div class="card-body">
             <!--    <div class="form-group col-md-10">
                ...
                <div class="form-group col-md-10">
                  <label class="control-label required"> Edit Category:</label>
                    <div class="controls">
                    <input type="text" class="form-control" name="title" id="category_name" value="{{$project_category->title}}" required>
                    </div>
                </div>
