      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-default">
            ...
            <form method="POST" action="{{ url('admin/add-testimonials') }}" enctype="multipart/form-data" id="addBanners">@csrf
                <div class="card-body">
                  ...
                  <div class="form-group col-md-10">
                        <div class="form-group col-md-10">
                        <label class="required">Testimonials Description</label>
                        <textarea name="description" class="textarea form-control" placeholder="Enter Testimonials Description" ></textarea>
                    </div>  
                  </div>
