        ...
        <div class="row">
          <div class="col-12"> 
            ...
            <div class="card">
                ...
                <!--<a href="{{ url('/admin/add-contact') }}"><button style="float: right; margin: 3px 3px;" class="btn btn-success btn-xl"><i class="fa fa-plus"></i> Add </button></a>-->
              </div>
              ...
              <div class="card-body">
                ...
                @foreach($contact as $row)
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-default"  id="editAbout" href="{{ url('/admin/edit-contact/'.$row->id) }}" title="Edit About"><i class="fa fa-edit" style="color: #000;"></i></a> &nbsp;&nbsp;
